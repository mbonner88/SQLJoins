...
FROM departments INNER JOIN categories ON categories.DepartmentID = departments.DepartmentID
...
SELECT * FROM products WHERE products.Name LIKE '%Visio%';
...
GROUP BY e.EmployeeID, p.ProductID ORDER BY e.FirstName;